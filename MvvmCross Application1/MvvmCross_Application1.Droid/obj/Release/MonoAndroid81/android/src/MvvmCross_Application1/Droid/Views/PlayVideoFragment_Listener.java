...
public class PlayVideoFragment_Listener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MvvmCross_Application1.Droid.Views.YouTubePlayerSample.PlayVideoFragment+Listener, MvvmCross_Application1.Droid", PlayVideoFragment_Listener.class, __md_methods);
	}


	public PlayVideoFragment_Listener ()
	{
		super ();
		if (getClass () == PlayVideoFragment_Listener.class)
			mono.android.TypeManager.Activate ("MvvmCross_Application1.Droid.Views.YouTubePlayerSample.PlayVideoFragment+Listener, MvvmCross_Application1.Droid", "", this, new java.lang.Object[] {  });
	}
